...
\begin{aligned}
    \frac{d S_l}{d t} & =\mu N_l-S_l\sum_{m=1}^n\sum_{i=1}^4 \lambda_{lim} V_{mi} -\mu S_l, \\
...
\begin{align*}
    0 & =\mu N_l-S_l\sum_{m=1}^n\sum_{i=1}^4 \lambda_{lim} V_{mi} -\mu S_l, \\
...
\begin{align*}
    0 & =\mu N-S\sum_{i=1}^4 \lambda_{i} V_{i} -\mu S, \\
